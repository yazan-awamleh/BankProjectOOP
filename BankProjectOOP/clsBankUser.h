...
private:
    ...
    {
        vector<string> vLoginRegisterRecords;
        vLoginRegisterRecords = clsString::Split(Line, Seperator);

        stLoginRegisterRecord LoginRegisterRecord;
        LoginRegisterRecord.DateAndTime = vLoginRegisterRecords[0];
        LoginRegisterRecord.UserName = vLoginRegisterRecords[1];
        LoginRegisterRecord.Password = clsUtil::DecryptText(vLoginRegisterRecords[2]);
        LoginRegisterRecord.Permissions = stoi(vLoginRegisterRecords[3]);
...
public:
    ...
    static vector <stLoginRegisterRecord> GetLoginRegisterRecordList()
    {
